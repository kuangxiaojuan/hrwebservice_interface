...
public class KmReviewParamterForm  implements java.io.Serializable {
    private com.landray.kmss.km.review.webservice.AttachmentForm[] attachmentForms;
    ...
    public KmReviewParamterForm(
           com.landray.kmss.km.review.webservice.AttachmentForm[] attachmentForms,
     ...
     */
    public com.landray.kmss.km.review.webservice.AttachmentForm[] getAttachmentForms() {
        return attachmentForms;
    }
     ...
     */
    public void setAttachmentForms(com.landray.kmss.km.review.webservice.AttachmentForm[] attachmentForms) {
        this.attachmentForms = attachmentForms;
    }

    public com.landray.kmss.km.review.webservice.AttachmentForm getAttachmentForms(int i) {
        return this.attachmentForms[i];
    }

    public void setAttachmentForms(int i, com.landray.kmss.km.review.webservice.AttachmentForm _value) {
