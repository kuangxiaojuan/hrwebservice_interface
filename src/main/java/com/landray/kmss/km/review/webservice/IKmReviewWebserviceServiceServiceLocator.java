...
public class IKmReviewWebserviceServiceServiceLocator extends org.apache.axis.client.Service implements com.landray.kmss.km.review.webservice.IKmReviewWebserviceServiceService {
    ...
    private java.lang.String IKmReviewWebserviceServicePort_address = "http://hometest.fhsjdz.com/sys/webservice/kmReviewWebserviceService";
    ...
    public com.landray.kmss.km.review.webservice.IKmReviewWebserviceService getIKmReviewWebserviceServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.landray.kmss.km.review.webservice.IKmReviewWebserviceService getIKmReviewWebserviceServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.landray.kmss.km.review.webservice.IKmReviewWebserviceServiceServiceSoapBindingStub _stub = new com.landray.kmss.km.review.webservice.IKmReviewWebserviceServiceServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.landray.kmss.km.review.webservice.IKmReviewWebserviceService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.landray.kmss.km.review.webservice.IKmReviewWebserviceServiceServiceSoapBindingStub _stub = new com.landray.kmss.km.review.webservice.IKmReviewWebserviceServiceServiceSoapBindingStub(new java.net.URL(IKmReviewWebserviceServicePort_address), this);
                _stub.setPortName(getIKmReviewWebserviceServicePortWSDDServiceName());
                return _stub;
            }
        }
